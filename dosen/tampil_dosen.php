                            ...
                            <tbody>
                                ...
                                while ($data = mysqli_fetch_array($tampil)) {
                                    ...
                                    <tr>
                                        ...
                                        <td><img src="../uploads/foto_dosen/<?= $data['foto'] ?>" width="80"></td>
                                        <td>
                                            <a href="edit_dosen.php?nidn=<?= $data['nidn'] ?>"
                                                class='btn btn-primary'>Edit</a>
                                            <a href="delete_dosen.php?nidn=<?= $data['nidn'] ?>" class='btn btn-danger'
                                                onclick="return confirm('Apakah anda yakin ingin menghapus ini ?')">
                                                Hapus</a>
                                            <a href="cetak_kartu_dosen.php?nidn=<?= $data['nidn'] ?>" target="_blank"
                                                class="btn btn-success btn-sm">Cetak Kartu Dosen</a>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
