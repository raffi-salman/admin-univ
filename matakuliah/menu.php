            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
                        data-bs-toggle="dropdown" aria-expanded="false">Data Mata Kuliah
                    </a>
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        <li><a class="dropdown-item" href="../dosen/tampil_dosen.php">Dosen</a></li>
                        <li><a class="dropdown-item" href="tampil_matakuliah.php">Mata Kuliah</a></li>
                        <li>
