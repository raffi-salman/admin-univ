                    ...
                    <div class="col-md-5 ">
                        <form method="POST" action="update_matakuliah.php">
                            ...
                            <div class="mb-3 mt-3">
                                ...
                                <input type="hidden" name="kode_matakuliah_tmp" value="<?=
                                    $data['kode_matakuliah'] ?>" class="form- control" id="kode_matakuliah_tmp"
                                    required>
                                <input type="text" name="kode_matakuliah" value="<?= $data['kode_matakuliah'] ?>"
                                    class="form- control" id="kode_matakuliah" placeholder="Masukan Kod Mata Kuliah"
                                    required>
                            </div>
                            <div class="mb-3 mt-3">
                                <label for="nama_matakuliah" class="form-label">Nama Mata Kuliah : </label>
                                <input type="text" name="nama_matakuliah" value="<?=

                                    $data['nama_matakuliah'] ?>" class="form-control" id="nama_matakuliah"
                                    placeholder="Masukan Nama Mata Kuliah" required>
                            </div>

                            <div class="mb-3">
                                <label for="sks" class="form-label">SKS :</label>
                                <input type="int" name="sks" value="<?= $data['sks'] ?>" class="form-control" id="sksr"
